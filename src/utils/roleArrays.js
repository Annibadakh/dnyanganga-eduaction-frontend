...
export const challanDetailAccess = [admin, subAdmin, counsellor, logistics];
export const challanByCounsellorAccess = [admin, subAdmin, counsellor, logistics];
export const bookEntryAccess = [admin, logistics];
export const bookDetailsAccess = [admin, subAdmin, counsellor, logistics];
export const bookConfirmAccess = [admin, counsellor, subAdmin];
