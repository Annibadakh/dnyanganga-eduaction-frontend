      ...
      <div className="flex items-center gap-2">
        ...
        {getPageNumbers().map((page, index) => (
          <button
            ...
            disabled={page === "..."}
            className={`px-3 py-2 text-sm border rounded ${page === currentPage ? "bg-primary text-white border-primary" : page === "..." ? "cursor-default" : "border-gray-300 hover:bg-gray-50"}`}
          >
            {page}
          </button>
        ))}
                            ...
                            <div className="flex items-center space-x-2">
                              ...
                              {user.role === "admin" && (
                                <>
                                  ...
                                  <button
                                    onClick={() => handleStudentStatus(student)}
                                    disabled={
                                      loadingStatusId === student.studentId
                                    }
                                    className={`${student.isActive ? "bg-red-500 hover:bg-red-600" : "bg-green-500 hover:bg-green-600"} text-white px-3 py-1 min-w-24 rounded transition-colors grid place-items-center disabled:opacity-50 disabled:cursor-not-allowed`}
                                  >
                                    {loadingStatusId === student.studentId ? (
                                      <span className="animate-spin h-4 w-4 border-2 border-white border-t-transparent rounded-full"></span>
                                    ) : student.isActive ? (
