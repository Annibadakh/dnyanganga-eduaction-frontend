        ...
        <div className="max-w-lg bg-white shadow-custom mx-auto md:p-6 p-2">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-3">
                    ...
                    <input type="number" value={receiptNo} onWheel={(e) => e.target.blur()} onChange={handleOnChange} required className="border p-2 w-full" />
                </div>
                ...
                <div className="mb-3">
                    ...
                    <input type="date" value={newDueDate} disabled={dueDate} onChange={handleDate} min={new Date().toISOString().split("T")[0]} className="border p-2 w-full" />
                </div>
