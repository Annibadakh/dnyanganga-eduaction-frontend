...
// Admin
const SubjectManagement = lazy(() => import("./Dashboard/AdminControls/SubjectManagement"));
const AddUser = lazy(() => import("./Dashboard/AdminControls/AddUser"));
const AddCenter = lazy(() => import("./Dashboard/AdminControls/AddCenter"));
const AdminCollection = lazy(() => import("./Dashboard/Collection/AdminCollection"));
const TemplatesManagementPage = lazy(() => import("./Dashboard/WhatsApp/TemplatesManagementPage"));
const JobCreation = lazy(() => import("./Dashboard/WhatsApp/JobCreation"));
const JobsList = lazy(() => import("./Dashboard/WhatsApp/JobsList"));
const MarksContextSelector = lazy(() => import("./Dashboard/Result/MarksContextSelector"));

// Counsellor & Shared
const RegistrationTable = lazy(() => import("./Dashboard/Registration/RegistrationTable"));
const RegistrationForm = lazy(() => import("./Dashboard/Registration/RegistrationForm"));
...
const ChallanManagement = lazy(() => import("./Dashboard/Books/ChallanManagement"));
...
const CounsellorCollection = lazy(() => import("./Dashboard/Collection/CounsellorCollection"));
          ...
          <Routes>
            ...
            >
              <Route path="dashboard" element={<Dashboard />}>
                ...
                <Route
                  element={
                    <ProtectedRoleBasedRoute allowedRoles={["counsellor", "admin"]} />
                  }
                >
                ...
                <Route
                  element={
                    <ProtectedRoleBasedRoute allowedRoles={["admin"]} />
                  }
                >
                ...
                <Route
                  element={
                    <ProtectedRoleBasedRoute allowedRoles={["admin", "logistics"]} />
                  }
                >
