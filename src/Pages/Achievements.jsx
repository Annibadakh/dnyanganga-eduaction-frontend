        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="max-w-3xl mx-auto text-center mb-14">
            <p className="text-lg text-gray-600 leading-relaxed">
              Over the years, we have consistently delivered strong academic
              results and meaningful student success through structured
              learning, expert guidance, and a student-centric approach.
            </p>
          </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-12">
              {achievements.map((achievement, index) => (
                ...
                >
                  ...
                  <p className="text-primary opacity-90 mb-4">
