...
import aboutimg from "../Images/aboutUs2.jpg";
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            <p className="text-lg text-gray-600 mb-6 leading-relaxed">
              With over 3 years of excellence in education, Dnyanganga Education
              Pvt. Ltd. has been a trusted partner for students preparing for
              board examinations. We specialize in conducting comprehensive mock
              board exams that closely mirror the actual board examination
              pattern.
            </p>
            <p className="text-gray-600 mb-6 leading-relaxed">
              Our mission is to build students’ confidence through rigorous
              practice and expert guidance, ensuring they approach their board
              examinations fully prepared and self-assured.
            </p>
