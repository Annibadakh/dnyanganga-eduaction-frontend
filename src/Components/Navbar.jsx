      ...
      <>
        <nav className={`fixed z-50 flex justify-between h-[70px] px-10 py-1 items-center   ${scrolled ? "top-0 left-0 right-0 bg-white border-b-2 border-solid border-gray-400" : "top-0 left-0  right-0 sm:top-8 bg-white sm:bg-transparent  sm:left-2 sm:right-2"}`}>
            ...
            <div className={`hidden sm:flex text-black font-semibold list-none gap-6 ${scrolled ? "pt-6" : "pt-0"}`}>
                ...
                <li className="hover:text-primary"><Link to="/dashboard">Courses</Link></li>
                <li className="hover:text-primary"><Link to="/dashboard">Exam Centre</Link></li>
                <li className="hover:text-primary"><Link to="/dashboard">Achievement</Link></li>
            ...
            <div className={`hidden sm:absolute font-semibold right-5 z-40 sm:flex list-none gap-6 px-10 py-2 ${scrolled ? "-top-1 text-primary" : "-top-6 text-white"}`}>
                ...
                <li>About Us</li>
                <li>Gallery</li>
                <li className="border-l-2 pl-3 border-solid border-gray-200">Call us: 7030830520</li>
            </div>
        ...
        {menuOpen && (
          <ul className="sm:hidden z-50 fixed font-semibold top-[70px] border-2 border-solid border-gray-200 min-w-40 items-center right-0 bg-white space-y-4 px-4 py-3 shadow-md">
            <li className="hover:text-primary">Home</li>
            <li className="hover:text-primary">About Us</li>
            ...
            <li className="hover:text-primary">Achievement</li>
